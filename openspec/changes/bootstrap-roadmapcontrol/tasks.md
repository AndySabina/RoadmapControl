...
- **B1 [approved and assigned issue #39](https://github.com/AndySabina/RoadmapControl/issues/39):** `internal/domain/roadmap/module.go`, `internal/domain/roadmap/module_test.go`, and `docs/roadmap-format.md`; **~180–300 lines**.
